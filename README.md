...
- Send the token directly in the `Authorization` header — no Bearer prefix needed
...
| 3 | POST | /api/issues | Authenticated | Create new issue |
| 4 | GET | /api/issues | Public | Get all issues (with filters) |
| 5 | GET | /api/issues/:id | Public | Get single issue |
| 6 | PATCH | /api/issues/:id | Authenticated | Update an issue |
| 7 | DELETE | /api/issues/:id | Maintainer only | Delete an issue |
...
**Arfan Ahmed Fahim**
- GitHub: [@Fahim7600](https://github.com/Fahim7600)
- LinkedIn: [Arfan Ahmed Fahim](https://linkedin.com/in/arfan-ahmed-fahim)
